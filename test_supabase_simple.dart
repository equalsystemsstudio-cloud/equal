...
void main() async {
  ...
  try {
    ...
    await Supabase.initialize(
      url: 'https://jzougxfpnlyfhudcrlnz.supabase.co',
      anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp6b3VneGZwbmx5Zmh1ZGNybG56Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg1NTg3NzksImV4cCI6MjA3NDEzNDc3OX0.gGRkxyfWlzQC2UrX-QTSB0J4-4w5J_Q9ZezZLCaznPY',
    );
      ...
      if (user != null) {
        ...
        try {
          ...
          try {
            ...
            print('⚠️  Failed to clean up test post: $e');
          }
        } catch (e) {
