-- Live Streams Database Schema for Supabase
-- Execute this in your Supabase SQL Editor

-- Idempotent pre-patch: ensure columns/indexes exist even if table predates this schema
BEGIN;
...
-- Ensure Mux-specific columns exist for view compatibility
...
CREATE TABLE IF NOT EXISTS public.live_streams (
  ...
  description TEXT,
  tags TEXT[] DEFAULT '{}',
  mux_stream_id VARCHAR(255) NOT NULL,
...
SELECT 
  ...
  u.avatar_url,
  u.is_verified,
  CASE WHEN ls.provider = 'livekit' AND ls.mux_playback_id IS NOT NULL THEN CONCAT('https://stream.mux.com/', ls.mux_playback_id, '.m3u8') ELSE ls.jitsi_stream_url END AS playback_url
...
/*
INSERT INTO public.live_streams (user_id, title, description, tags, mux_stream_id, mux_playback_id, stream_key, status)
VALUES 
  ((SELECT id FROM public.users LIMIT 1), 'Test Live Stream', 'This is a test stream', ARRAY['test', 'demo'], 'test_mux_id', 'test_playback_id', 'test_stream_key', 'live');
*/
